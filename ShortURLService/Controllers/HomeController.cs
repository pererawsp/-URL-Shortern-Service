...
namespace ShortURLService.Controllers
{
    ...
    (System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
            ...
            else
            {
                ...
                if (existingURL == null)
                {
                    ...
                    if (shortUrl.CheckLongUrlExists())
                    {
                        ...
                        return Json(new { status = false, message = "Provided URL is Not valid" }, JsonRequestBehavior.AllowGet);
                }
                else
                {
        ...
        [AllowAnonymous]
        [HttpGet]
        public ActionResult ShorterURLAPI()
        {

            string longUrl = "";
            if(Request["l-url"]!=null)
            {
                longUrl = Request["l-url"].ToString();
            }
            else
            {
                longUrl = "";
